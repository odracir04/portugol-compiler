...
PROGRAM_HEADER: PROGRAM_NAME NEWLINE_ 
                | PROGRAM_HEADER NEWLINE_;
PROGRAM_BODY:   FUNCTIONS_AND_VARIABLES ALGORITHM;

PROGRAM_NAME: ALGORITMO_ VAR_NAME_;
...
ALGORITHM_HEADER: INICIO_ NEWLINE_ | ALGORITHM_HEADER NEWLINE_;
ALGORITHM_BODY: STATEMENT_LIST ALGORITHM_END;
ALGORITHM_END: FIMALGORITMO_ | ALGORITHM_END NEWLINE_;


STATEMENT_LIST: STATEMENT | STATEMENT STATEMENT_LIST;
STATEMENT: ASSIGNMENT NEWLINE_ | STATEMENT NEWLINE_ | IFELSE NEWLINE_ | SWITCH_STATEMENT NEWLINE_
            | WRITE_STATEMENT NEWLINE_ | READ_STATEMENT NEWLINE_ | FOR_STATEMENT NEWLINE_ | WHILE_STATEMENT NEWLINE_
            | DOWHILE_STATEMENT NEWLINE_ | BREAK_ NEWLINE_ | FUNCTION_CALL NEWLINE_

...
FACTOR: TERM
        ...
        | FACTOR DIFFERENCE;
SUM: PLUS TERM;
DIFFERENCE: MINUS TERM;        
TERM: INTEGRAL
    | TERM MULTIPLICATION
    | TERM DIVISION
    | TERM REMAINDER;
MULTIPLICATION: TIMES INTEGRAL;
DIVISION: DIVIDE INTEGRAL;
REMAINDER: MODULO INTEGRAL;    
INTEGRAL: LITERAL
        | VAR_NAME
        | PARENTHESES CLOSE_CURLY
        | FUNCTION_CALL;
PARENTHESES: OPEN_CURLY MATH_EXPRESSION;        

...
HEADER: TITLE;
TITLE: ALGORITMO VAR_NAME NEWLINE { create_data_section(); } | TITLE NEWLINE;
...
ALGORITHM_START: INICIO NEWLINE { create_text_section(); } | ALGORITHM_START NEWLINE;
ALGORITHM_END: FIMALGORITMO { terminate_program(); } | ALGORITHM_END NEWLINE;

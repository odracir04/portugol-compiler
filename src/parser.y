...
FOR_BEGIN: FOR VAR_NAME FROM MATH_EXPRESSION TO MATH_EXPRESSION DO NEWLINE
           | FOR VAR_NAME FROM MATH_EXPRESSION TO MATH_EXPRESSION STEP MATH_EXPRESSION DO NEWLINE;
FOR_END: ENDFOR;
